...
Config.BreakChance = 1 -- What percentage chance should a pickaxe have to break
...
Config.Selling = {
    ...
    coords = vec3(-97.18, -1013.97, 26.30), -- The location at which the ped will spawn 
    heading = 164.29, -- The direction at which the ped will face
